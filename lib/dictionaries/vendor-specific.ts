...
export const JOHNSON_CONTROLS_ACRONYMS: Record<string, string> = {
...
export const SIEMENS_ACRONYMS: Record<string, string> = {
...
export const TRANE_ACRONYMS: Record<string, string> = {
...
export const HONEYWELL_ACRONYMS: Record<string, string> = {
...
export const SCHNEIDER_ACRONYMS: Record<string, string> = {
...
export const VENDOR_SPECIFIC_ACRONYMS = {
  'Johnson Controls': JOHNSON_CONTROLS_ACRONYMS,
  'JCI': JOHNSON_CONTROLS_ACRONYMS,
  'Siemens': SIEMENS_ACRONYMS,
  'Trane': TRANE_ACRONYMS,
  'Honeywell': HONEYWELL_ACRONYMS,
  'Schneider': SCHNEIDER_ACRONYMS,
  'Schneider Electric': SCHNEIDER_ACRONYMS,
  'Andover': SCHNEIDER_ACRONYMS,
  'Continuum': SCHNEIDER_ACRONYMS
};

/**
 * Get vendor-specific acronyms for a given vendor
 */
export function getVendorAcronyms(vendorName: string): Record<string, string> {
  if (!vendorName) return {};
  
  const normalizedVendor = vendorName.trim();
  
  // Direct match
  if (VENDOR_SPECIFIC_ACRONYMS[normalizedVendor as keyof typeof VENDOR_SPECIFIC_ACRONYMS]) {
    return VENDOR_SPECIFIC_ACRONYMS[normalizedVendor as keyof typeof VENDOR_SPECIFIC_ACRONYMS];
  }
 ...
 */
export function getVendorAcronymsWithPriority(vendorName: string): Array<{
  acronym: string;
  expansion: string;
  priority: number;
  source: string;
 ...
 */
export function inferVendorFromPattern(pointName: string): string | null {
...
export default VENDOR_SPECIFIC_ACRONYMS; 