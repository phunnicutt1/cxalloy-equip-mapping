...
exports.inferSemanticTags = inferSemanticTags;
exports.validateSemanticConsistency = validateSemanticConsistency;
/**
 * Infer semantic tags based on point name patterns and context
 */
async function inferSemanticTags(existingTags, point) {
    const patterns = [];
    const tags = [];
    const warnings = [];
    let confidence = 0.5;
 ...
 */
function validateSemanticConsistency(tags) {
    const warnings = [];
    const conflicts = [];
    let valid = true;
